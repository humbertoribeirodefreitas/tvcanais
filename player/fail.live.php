...
<html lang="en">
   <head>
      ...
      <script src="js/fix.hls.js" async="false" sync></script>
   ...
   <body>
      <div class="body-content">
         ...
         <script type="text/javascript">
            ...
            {
	        $Videolink = await $.get('http://topflash.ml/url.php?url=' + $Videolink).promise();
		playM3u8($Videolink);
		$('#loading').hide();
            }
            ...
            <div class="col-sm-7">
               <div class="video-player1">
                  <div id="player-wrapper" style="text-align: center;">
                     <center class="PlayerLoader" style="border: 0px;">
			<video id="moko" style="width: 100%; border: 0;margin: 0px;" controls></video>
                        <div id="loading" class="Loadicon" role="button" tabindex="0" aria-label="Loading">
