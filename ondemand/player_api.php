...
$raw = file_get_contents('/usr/share/nginx/html/save.list');
$raw = file_get_contents('https://topflash.ml//exibir.php?usuario='.($usuarioB['acesso']).'&lista=17');
$_SESSION['raw'] = $raw;
$lines = explode("\n", $_SESSION['raw']);
...
if (isset($_GET['username']) && isset($_GET['password']))
{
    switch ($_GET['action'])
    {
        case "get_live_categories":
            $output = [];
            $output[] = ["category_id" => 1, "category_name" => "Canais de TV", "parent_id" => 0];
